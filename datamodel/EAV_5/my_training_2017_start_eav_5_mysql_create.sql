...
ALTER TABLE `value ` ADD CONSTRAINT `value _fk0` FOREIGN KEY (`id_entity`) REFERENCES `entity_ids`(`id_entity`);

ALTER TABLE `value ` ADD CONSTRAINT `value _fk1` FOREIGN KEY (`id_attribute`) REFERENCES `attributes`(`id_attribute`);
